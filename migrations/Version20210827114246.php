 ...
 */
final class Version20210827114246 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courrier (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recipient_id INT DEFAULT NULL, date_envoie DATETIME NOT NULL, objet_courrier VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, type_courrier VARCHAR(50) NOT NULL, is_valid TINYINT(1) NOT NULL, is_read TINYINT(1) NOT NULL, is_archived TINYINT(1) DEFAULT NULL, is_in_trashed TINYINT(1) DEFAULT NULL, is_send TINYINT(1) DEFAULT NULL, fichier VARCHAR(255) DEFAULT NULL, INDEX IDX_BEF47CAAF624B39D (sender_id), INDEX IDX_BEF47CAAE92F8F78 (recipient_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, fonction_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, telephone VARCHAR(15) NOT NULL, email VARCHAR(100) NOT NULL, adresse VARCHAR(50) NOT NULL, username VARCHAR(100) NOT NULL, password VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', picture VARCHAR(255) DEFAULT NULL, INDEX IDX_8D93D64957889920 (fonction_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
