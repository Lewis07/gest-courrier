 ...
 */
final class Version20210910182411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE courrier (id INT AUTO_INCREMENT NOT NULL, sender_id INT NOT NULL, recipient_id INT DEFAULT NULL, type_courrier_id INT NOT NULL, date_envoie DATETIME NOT NULL, priorite VARCHAR(50) NOT NULL, objet_courrier VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, is_valid TINYINT(1) NOT NULL, is_read TINYINT(1) NOT NULL, is_archived TINYINT(1) DEFAULT NULL, is_in_trashed TINYINT(1) DEFAULT NULL, is_send TINYINT(1) DEFAULT NULL, fichier VARCHAR(255) DEFAULT NULL, reference VARCHAR(10) DEFAULT NULL, is_shared TINYINT(1) DEFAULT NULL, INDEX IDX_BEF47CAAF624B39D (sender_id), INDEX IDX_BEF47CAAE92F8F78 (recipient_id), INDEX IDX_BEF47CAAC0EDCA56 (type_courrier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE courrier_archive (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, courrier_id INT NOT NULL, is_in_trashed TINYINT(1) DEFAULT NULL, INDEX IDX_90051080A76ED395 (user_id), INDEX IDX_900510808BF41DC7 (courrier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE dossier (id INT AUTO_INCREMENT NOT NULL, courrier_id INT NOT NULL, typ_dos_id INT NOT NULL, INDEX IDX_3D48E0378BF41DC7 (courrier_id), INDEX IDX_3D48E03751688E54 (typ_dos_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE type_courrier (id INT AUTO_INCREMENT NOT NULL, libelle_type_courrier VARCHAR(90) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
